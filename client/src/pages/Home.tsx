  ...
  return (
      ...
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <p className="text-center text-base max-w-md mt-2">
          Create, customize and public website faster than ever with our AI site Builder
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
          ...
          <img className="max-w-28 md:max-w-32" src="https://download.logo.wine/logo/Huawei/Huawei-Logo.wine.png" alt="" />
          <img className="max-w-28 md:max-w-32" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/960px-Instagram_logo.svg.png?_=20160616034027" alt="" />
          <img className="max-w-28 md:max-w-32" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_%282012%29.svg/1280px-Microsoft_logo_%282012%29.svg.png" alt="" />
          <img className="max-w-28 md:max-w-32" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Walmart_logo_%282025%3B_Alt%29.svg/960px-Walmart_logo_%282025%3B_Alt%29.svg.png" alt="" />
