        ...
        <div className='space-y-4 text-black'>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <div>
                    ...
                    <input type='color'
                     value={values.styles.backgroundColor === 'rgba(0,0,0,0)' ? '#ffffff' : values.styles.backgroundColor} onChange={(e)=> handleStyleChange('backgroundColor', e.target.value)}  className='w-6 h-6 rounded cursor-pointer '/>
                ...
                <div>
                    ...
                    <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                    <input type='text'
                     value={values.styles.color} onChange={(e)=> handleStyleChange('color', e.target.value)}  className='w-6 h-6 rounded cursor-pointer '/>
